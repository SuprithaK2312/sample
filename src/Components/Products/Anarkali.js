            ...
            <div id="anarkali-container">
                <div className="product" id='anarkali1'>
                    ...
                    <div className='product-info'>
                        <p className='product-name'>Navy blue anarkali</p>
                ...
                <div className="product" id='anarkali2'>
                    ...
                    <div className='product-info'>
                        <p className='product-name'>White royal cotton anarkali</p>
                ...
                <div className="product" id='anarkali3'>
                    ...
                    <div className='product-info'>
                        <p className='product-name'>White embroidery anarkali</p>
                ...
                <div className="product" id='anarkali4'>
                    ...
                    <div className='product-info'>
                        <p className='product-name'>Light pink floral anarkali</p>
                        <p className='product-price'>&#8377;899</p>
                    </div>
                </div>
                ...
                <div className="product" id='anarkali5'>
                    ...
                    <div className='product-info'>
                        <p className='product-name'>Dark aesthetic brown anarkali</p>
                ...
                <div className="product" id='anarkali6'>
                    ...
                    <div className='product-info'>
                        <p className='product-name'>Bloody red royal anarkali</p>
                        <p className='product-price'>&#8377;899</p>
                    </div>
                </div>
                ...
                <div className="product" id='anarkali7'>
                    ...
                    <div className='product-info'>
                        <p className='product-name'>Light blue office wear anarkali</p>
                ...
                <div className="product" id='anarkali8'>
                    ...
                    <div className='product-info'>
                        <p className='product-name'>Dark pink royal anarkali</p>
                ...
                <div className="product" id='anarkali9'>
                    ...
                    <div className='product-info'>
                        <p className='product-name'>White with red italian kaftan anarkali</p>
                ...
                <div className="product" id='anarkali10'>
                    ...
                    <div className='product-info'>
                        <p className='product-name'>Navy blue printed anarkali</p>
                        <p className='product-price'>&#8377;899</p>
                    </div>
                </div>
                ...
                <div className="product" id='anarkali11'>
                    ...
                    <div className='product-info'>
                        <p className='product-name'>Purple and majenta mixed anarkali</p>
                        <p className='product-price'>&#8377;899</p>
                    </div>
                </div>
                ...
                <div className="product" id='anarkali12'>
                    ...
                    <div className='product-info'>
                        <p className='product-name'>Baby pink and white embroidery anarkali</p>
                        <p className='product-price'>&#8377;999</p>
                    </div>
                </div>
                ...
                <div className="product" id='anarkali13'>
                    ...
                    <div className='product-info'>
                        <p className='product-name'>Bloody merun fancy anarkali</p>
                ...
                <div className="product" id='anarkali14'>
                    ...
                    <div className='product-info'>
                        <p className='product-name'>Pink floral printed anarkali</p>
                ...
                <div className="product" id='anarkali15'>
                    ...
                    <div className='product-info'>
                        <p className='product-name'>Dark blue fancy anarakali</p>
                        <p className='product-price'>&#8377;899</p>
                    </div>
                </div>
                ...
                <div className="product" id='anarkali16'>
                    ...
                    <div className='product-info'>
                        <p className='product-name'>Brown multi-color royal chudidhar</p>
                        <p className='product-price'>&#8377;999</p>
                    </div>
                </div>
            </div>
