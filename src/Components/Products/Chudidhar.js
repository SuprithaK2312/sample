            ...
            <div id="chudidhar-container">
                <div className="product" id='chudidhar1'>
                    ...
                    <div className='product-info'>
                        <p className='product-name'>Black with orange gazatte chudidhar</p>
                ...
                <div className="product" id='chudidhar2'>
                    ...
                    <div className='product-info'>
                        <p className='product-name'>White with brown cotton chudidhar</p>
                ...
                <div className="product" id='chudidhar3'>
                    ...
                    <div className='product-info'>
                        <p className='product-name'>Olive green with white cotton chudidhar</p>
                ...
                <div className="product" id='chudidhar5'>
                    ...
                    <div className='product-info'>
                        <p className='product-name'>Dark aesthetic pattern chudidhar</p>
                ...
                <div className="product" id='chudidhar6'>
                    ...
                    <div className='product-info'>
                        <p className='product-name'>Chocolate green pattern chudidhar</p>
                        <p className='product-price'>&#8377;899</p>
                    </div>
                </div>
                ...
                <div className="product" id='chudidhar7'>
                    ...
                    <div className='product-info'>
                        <p className='product-name'>Yellow leaf embroidery chudidhar</p>
                ...
                <div className="product" id='chudidhar8'>
                    ...
                    <div className='product-info'>
                        <p className='product-name'>Black leaf embroidery chudidhar</p>
                ...
                <div className="product" id='chudidhar9'>
                    ...
                    <div className='product-info'>
                        <p className='product-name'>White with red italian kaftan chudidhar</p>
                ...
                <div className="product" id='chudidhar10'>
                    ...
                    <div className='product-info'>
                        <p className='product-name'>Black with red italian kaftan chudidhar</p>
                        <p className='product-price'>&#8377;899</p>
                    </div>
                </div>
                ...
                <div className="product" id='chudidhar11'>
                    ...
                    <div className='product-info'>
                        <p className='product-name'>Navy blue with olive green pattern chudidhar</p>
                        <p className='product-price'>&#8377;899</p>
                    </div>
                </div>
                ...
                <div className="product" id='chudidhar12'>
                    ...
                    <div className='product-info'>
                        <p className='product-name'>Pulpy red with white cotton chudidhar</p>
                        <p className='product-price'>&#8377;999</p>
                    </div>
                </div>
                ...
                <div className="product" id='chudidhar13'>
                    ...
                    <div className='product-info'>
                        <p className='product-name'>Black royal chudidhar</p>
                ...
                <div className="product" id='chudidhar14'>
                    ...
                    <div className='product-info'>
                        <p className='product-name'>Multi-green pattern fancy chudidhar</p>
                ...
                <div className="product" id='chudidhar15'>
                    ...
                    <div className='product-info'>
                        <p className='product-name'>Black with white floral chudidhar</p>
                        <p className='product-price'>&#8377;899</p>
                    </div>
                </div>
                ...
                <div className="product" id='chudidhar16'>
                    ...
                    <div className='product-info'>
                        <p className='product-name'>Black multi-color royal chudidhar</p>
                        <p className='product-price'>&#8377;999</p>
                    </div>
